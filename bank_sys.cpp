...
string rec_email = "da", rec_password = "da";
...
void deposit() {
    do {
        ...
        if (depositAmount > depositLimit) {
            ...
            cout << "New balance: " << fixed << setprecision(2) << balance << " PHP\n";
...
void checkInterest() {
    ...
    cout << "Final Total: Php " << (invested + earned) << endl;
}
